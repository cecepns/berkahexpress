...
const BankAccountManagement = () => {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Manajemen Rekening Bank</h1>
        <p className="mt-2 text-gray-600">Kelola rekening bank untuk topup pelanggan</p>
      </div>
        ...
        {filteredAccounts.length === 0 && (
          <div className="text-center py-12">
            <p className="text-sm text-gray-500">
              {searchTerm ? 'Tidak ada rekening yang ditemukan' : 'Belum ada data rekening'}
            </p>
          </div>
        )}
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  required
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 font-mono"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="PT. BerkahExpress Indonesia"
                />
              </div>
              ...
              <div className="bg-blue-50 p-3 rounded-md">
                <p className="text-xs text-blue-600">
                  <strong>Info:</strong> Hanya rekening yang aktif yang akan ditampilkan kepada pelanggan untuk topup.
                </p>
              </div>
